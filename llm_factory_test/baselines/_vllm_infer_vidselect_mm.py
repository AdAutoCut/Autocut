        ...
        while queue or engine.has_unfinished_requests():
            if queue:
                ...
                try:
                    ...
                    out_obj = build_output_record(base_records[idx], "")
...
def parse_args():
    ...
    parser.add_argument(
        "--prompts_path",
        type=str,
        default="/data/phd/miltonzhou/sft/data_preprocess/T_baseline_mm_vidsort.json",
    ...
    parser.add_argument(
        "--result_path",
        type=str,
        default="/data/phd/qinsizhong/llm_factory_test/baselines/results/F___vidsort_Qwen3vl.jsonl",
