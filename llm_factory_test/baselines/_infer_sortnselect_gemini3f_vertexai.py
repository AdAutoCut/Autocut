...
def parse_args():
    ...
    ap.add_argument("--project_id", default="ad-62902-gemini")
    ap.add_argument("--location", default="global")
    ap.add_argument("--model", default="gemini-3-flash-preview")

    ap.add_argument("--prompts_path", default="/data/phd/qinsizhong/miltonzhou/sft/data_preprocess/T_baseline_mm_vidsort.json")
    ap.add_argument("--frames_dir", default="/data/phd/qinsizhong/miltonzhou/sft/data_preprocess/filter_data/downloaded_frames")
    ap.add_argument("--output_path", default="/data/phd/qinsizhong/llm_factory_test/baselines/results/F___vidsort_gemini3f.jsonl")
