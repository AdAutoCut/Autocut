...
from audio.Vocal_split_pb2_grpc import VocalSplitServingStub
...
def batch_demo_8(grpc_service_name):
    # 小说音频复刻
    req = VocalSplitRequest(vocal_blob_key={"db": "ad", "table": "nieuwland-material", "key": "audio_000002.mp3"})
    client = VocalSplitClient(grpc_service_name)
